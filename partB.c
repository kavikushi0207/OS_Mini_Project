...
// //     exit(1);
// //     }
// //     else{printf("successfully written into the file\n");}
...
//     // File pointer to read from file
    ...
    // }
    // // counting the number of students to calculate average
...
//         }
        ...
        //     //pid_t wpidRet = waitpid(PID2,NULL,0);
...
//         sndMsg[1]=create_msg(200,gcvt(avgSum/studcount,6,sndMsg[1].text));
